...
python example/autoencoder/train_ae.py          --mnist "${DATA}" --model example/autoencoder/variational_autoencoder.yml
python example/gan/train_gan.py                 --mnist "${DATA}" --model example/gan/model.yml
